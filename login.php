...
// Simulate some debug/test message to check session values
echo "<pre>SESSION STATUS:\n";
print_r($_SESSION);
echo "</pre>";

// Check if the session is already started
if (isset($_SESSION['user'])) { // Make sure 'user' is set during login
    echo "<script>alert('You are already logged in. Redirecting to home...');</script>";
    // Redirect after short delay to allow alert to show
    echo "<script>setTimeout(function() {
        window.location.href = 'http://localhost/car/index.php';
    }, 1500);</script>";
...
<body>
    ...
    <div class="impl_btm_footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <p class="impl_copyright">Copyright &copy; 2022 Impel Car Dealers. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </div>
